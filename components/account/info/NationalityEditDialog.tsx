...
import {  setNationalityDialogOpen, updateNationalId, updateNationality } from 'components/account/accountSlice';
    ...
    const update = async () => {
        ...
        axio2(user_token)
            ...
            .then((response) => {
                ...
                dispatch(setNationalityDialogOpen(false))
            })
            .catch((error) => {
                console.log(error);
                dispatch(setNationalityDialogOpen(false))
