...
import Contents800_2_flexdirection from './Contents800_2_flexdirection'

export function SelectLocationContents() {
  ...
  return (
    <Contents800_2_flexdirection>
      ...
      <Select
        value={region}
        onValueChange={(text) => { setRegion(text); getDistrict(text); console.log(text) }}
